# Lab 34 Worksheet — Linux Command Line Essentials on Killercoda
...
**Success criterion:** Every command runs without error on the playground; grep returns exactly two ERROR lines from the log; ls -l confirms the 640 permission as rw-r-----; and your reference records real output for each command rather than expected output.
